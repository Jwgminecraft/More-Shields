...
public class MoreShields implements ModInitializer {
	...
	public static final Item OVERWORLD_NETHERITE_SHIELD = new FabricShieldItem(new FabricItemSettings().maxDamage(3500).group(MORE_SHIELDS_ADDITIONS), 10, 13, Items.NETHERITE_INGOT);
	public static final Item NETHER_NETHERITE_SHIELD = new FabricShieldItem(new FabricItemSettings().maxDamage(3500).group(MORE_SHIELDS_ADDITIONS), 10, 13, Items.NETHERITE_INGOT);
	public static final Item END_NETHERITE_SHIELD = new FabricShieldItem(new FabricItemSettings().maxDamage(3500).group(MORE_SHIELDS_ADDITIONS), 10, 13, Items.NETHERITE_INGOT);
	@Override
	public void onInitialize() {

		if (FabricLoader.getInstance().isModLoaded("specialisednetherite") == true) {
